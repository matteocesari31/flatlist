    ...
    >
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          ...
          {/* Premium Plan */}
          <div className="p-4 border-2 border-black rounded-xl bg-white relative">
            <div className="absolute -top-2.5 left-4 bg-black text-white text-xs px-2 py-0.5 rounded-full">
              Recommended
            </div>
            <div className="text-sm font-medium text-gray-500 mb-1">Premium</div>
            <div className="text-2xl font-bold mb-1">€19.99<span className="text-sm font-normal text-gray-500">/year</span></div>
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            disabled={loading}
            className="flex-1 px-4 py-3 bg-black text-white rounded-xl hover:bg-gray-800 disabled:opacity-50 disabled:cursor-not-allowed transition-colors font-medium"
          >
            {loading ? (
