      ...
      <div className="pt-2 flex flex-col">
        ...
        {(metadata || basicInfo) && (
          <div className="space-y-1">
              ...
              <div className="flex items-center justify-between">
                <div className="text-xl font-bold text-white">
                  ...
                  {!metadata && basicInfo?.price && (
                    <span className="text-xs font-normal text-[#979797] ml-2">(extracted)</span>
                  )}
                </div>
              </div>
            )}
            ...
            {(metadata?.address || basicInfo?.address) && (
              <div className="text-sm text-gray-200">
                ...
                {!metadata && basicInfo?.address && (
                  <span className="text-xs text-[#979797] ml-1">(from title)</span>
                )}
              </div>
            )}
            ...
            {metadata && (
              <div className="mt-2 flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-[#979797]">
            ...
            {!metadata && status !== 'failed' && (
              <div className="text-xs text-[#979797] mt-2">
                {status === 'processing' 
