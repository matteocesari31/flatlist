      ...
      cards.push({
        ...
        renderContent: () => (
          <>
            ...
            {evidence && <p className="text-sm text-[#979797]">{evidence}</p>}
          </>
        )
      })
    }
  ...
  return (
    <>
      ...
      {showDeleteConfirm && (
        ...
        >
          <div
            className="bg-[#0B0B0B] rounded-[30px] max-w-md w-full p-6 shadow-2xl border border-gray-700"
    ...
    >
      <div
        className="bg-[#0B0B0B] rounded-[30px] max-w-6xl w-full max-h-[95vh] overflow-hidden flex flex-col shadow-2xl relative"
        style={{
      ...
      >
        ...
        {/* Content */}
        <div className="flex-1 overflow-y-auto pl-4 pr-6 pt-4 pb-4">
          <div className="flex gap-6 items-stretch">
                    ...
                    <div className="absolute bottom-4 left-4 right-4 md:right-auto md:max-w-md flex flex-col gap-2">
                      ...
                      >
                        {comparisonSummary ? (
                          ...
                          <p className="text-sm text-[#979797] italic">Comparison complete. Summary being generated...</p>
                        ) : isEvaluatingListing ? (
                          ...
                          <p className="text-sm text-[#979797] italic">AI is evaluating this listing. This may take a moment…</p>
                        )}
                      </div>
                    </div>
                  )}
            ...
            <div className="flex-shrink-0 w-[30%] flex flex-col pr-4 min-h-0" ref={rightColumnRef}>
              ...
              <div className="mt-3">
                <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-sm text-[#979797]">
                  ...
                  <div className="bg-gray-800/50 rounded-[20px] p-5 border border-gray-700/50">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-[#979797] mb-3">
