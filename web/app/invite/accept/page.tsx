  ...
  useEffect(() => {
    ...
    const checkInvitation = async () => {
      try {
        ...
        // If user is not authenticated, redirect to auth with token
        if (!currentUser) {
        ...
        // Fetch invitation (user is authenticated, so RLS should allow if email matches)
        ...
        // Count user's existing listings (from catalogs they created)
