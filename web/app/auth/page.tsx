      ...
      <div className="w-full max-w-md">
        ...
        <div className="backdrop-blur-md bg-black/60 border border-white/15 rounded-[20px] p-6 shadow-lg" style={{ backdropFilter: 'blur(12px)' }}>
          ...
          <button
            ...
            disabled={loading}
            className="w-full px-4 py-3 bg-white text-black rounded-xl hover:bg-gray-200 disabled:opacity-50 disabled:cursor-not-allowed transition-colors font-medium flex items-center justify-center gap-2"
          >
